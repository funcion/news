                                        ...
                                        \Filament\Schemas\Components\Grid::make(2)
                                            ->schema([
                                                Toggle::make('is_indexable')
                                                    ...
                                                    ->helperText('Activado: Los buscadores como Google indexarán esta categoría en sus resultados.')
                                                    ->default(true),
                                                Toggle::make('is_followable')
                                                    ->label('¿Permitir Rastreo de Enlaces? (follow / nofollow)')
                                                    ->helperText('Activado: Los rastreadores seguirán los enlaces de esta categoría.')
                                                    ->default(true),
                                            ])->columnSpanFull(),
