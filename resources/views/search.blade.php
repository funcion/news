    ...
    <div class="max-w-4xl mx-auto px-4 py-8 lg:py-14">
        ...
        <div class="mb-10">
            ...
            <form action="{{ url($locale === 'es' ? '/es/search' : '/search') }}" method="GET" class="relative">
                ...
                <button type="submit" class="absolute right-3 top-1/2 -translate-y-1/2 px-5 py-2.5 rounded-xl bg-[#2b7fff] hover:bg-blue-600 text-white text-xs font-bold uppercase tracking-wider transition-colors shadow-sm">
