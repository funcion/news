        ...
        <div class="py-20 sm:py-28 border-b border-slate-200/70 dark:border-slate-800/80">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-12">
                ...
                <div class="flex flex-col">
                    <div class="w-14 h-14 rounded-2xl bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 flex items-center justify-center mb-6">
                ...
                <!-- Column 2: Visión -->
                <div class="flex flex-col">
                    <div class="w-14 h-14 rounded-2xl bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-6">
                        <svg class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- Column 3: Valores -->
                <div class="flex flex-col">
                    <div class="w-14 h-14 rounded-2xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-6">
                        <svg class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
