<x-layouts.app :trendingTags="$trendingTags">
    ...
    <!-- Header Section -->
    <div class="mb-8 pb-4 border-b border-gray-100 dark:border-white/5 relative max-w-5xl mx-auto">
    ...
    <!-- 2-Column Master Categories Grid (Centered) -->
    <div class="max-w-5xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 justify-center">
            @foreach($categories as $cat)
                ...
                @endphp
                <article class="group relative flex flex-col justify-between rounded-xl bg-white dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800 p-5 shadow-xs hover:shadow-lg hover:border-cyan-500/40 dark:hover:border-cyan-500/40 transition-all duration-200">
