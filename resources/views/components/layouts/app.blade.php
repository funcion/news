                            ...
                            <div x-data="{ userMenuOpen: false }" class="relative inline-block">
                                ...
                                <div x-show="userMenuOpen"
                                    ...
                                    <div class="p-1 space-y-0.5">
                                        @if (auth()->user()->hasAnyRole(['super_admin', 'editor_jefe', 'redactor', 'moderador']) || in_array(auth()->user()->email, ['sifuncion@gmail.com', 'admin@glodaxia.com', 'luis.figuera@glodaxia.com']))
