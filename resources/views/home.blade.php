                ...
                <template x-if="!submitted">
                    <div class="flex flex-col gap-3">
                        ...
                        <input id="newsletter-email" 
                               ...
                               class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:border-cyan-500 dark:focus:border-cyan-400 focus:bg-white dark:focus:bg-slate-800 focus:ring-2 focus:ring-cyan-500/10 transition-all font-medium">
                        
                        <button type="submit" 
                                :disabled="loading" 
                                class="w-full bg-[#2b7fff] hover:bg-blue-600 active:scale-[0.98] disabled:opacity-50 text-white text-xs font-bold uppercase tracking-wider py-3.5 rounded-xl shadow-md shadow-blue-500/20 transition-all flex items-center justify-center gap-2">
