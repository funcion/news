                ...
                <template x-if="!submitted">
                    <div class="flex flex-col gap-3">
                        ...
                        <input id="newsletter-email" 
                               ...
                               class="w-full h-11 px-4 text-sm font-medium rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:border-cyan-500 dark:focus:border-cyan-400 focus:bg-white dark:focus:bg-slate-800 transition-all">
                        
                        <button type="submit" 
                                :disabled="loading" 
                                class="w-full h-11 px-5 rounded-xl bg-[#2b7fff] hover:bg-blue-600 active:scale-[0.99] disabled:opacity-50 text-white text-sm font-bold shadow-md shadow-blue-500/20 transition-all flex items-center justify-center gap-2">
