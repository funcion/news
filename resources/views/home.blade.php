    ...
    <x-slot:sidebar>
        ...
        <div class="p-6 md:p-7 rounded-2xl bg-white dark:bg-slate-900 text-slate-900 dark:text-white relative overflow-hidden group border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <form x-data="{
                  ...
                  class="relative z-10 flex flex-col gap-3.5">
                ...
                <template x-if="!submitted">
                    <div class="flex flex-col gap-3">
                        ...
                        <input id="newsletter-email" 
                               ...
                               class="w-full h-11 px-4 text-sm font-medium rounded-lg bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 outline-none focus:border-cyan-500 dark:focus:border-cyan-400 focus:bg-white dark:focus:bg-slate-800 transition-all">
                        
                        <button type="submit" 
                                :disabled="loading" 
                                class="w-full h-11 px-4 rounded-lg bg-cyan-500 hover:bg-cyan-600 active:scale-[0.99] disabled:opacity-50 text-white text-sm font-bold tracking-wide transition-all shadow-sm shadow-cyan-500/20 flex items-center justify-center gap-2">
                ...
                <template x-if="submitted">
                    <div :class="isSuccess ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-800 dark:text-emerald-300' : 'bg-rose-500/10 border-rose-500/30 text-rose-800 dark:text-rose-300'" class="p-4 rounded-xl border text-xs leading-relaxed flex flex-col gap-3">
