    ...
    <div class="max-w-4xl mx-auto px-4 py-8 lg:py-16">
        ...
        <div class="prose prose-slate dark:prose-invert max-w-none prose-headings:font-black prose-headings:tracking-tight prose-headings:text-slate-900 dark:prose-headings:text-white prose-p:text-slate-700 dark:prose-p:text-slate-300 prose-p:leading-relaxed prose-li:text-slate-700 dark:prose-li:text-slate-300 prose-strong:text-slate-900 dark:prose-strong:text-white prose-a:text-cyan-600 dark:prose-a:text-cyan-400">
            @if(app()->getLocale() === 'es')
                ...
                <p>
                    El responsable del tratamiento de los datos recabados en este sitio web es el equipo editorial de <strong>Glodaxia</strong>. Para cualquier consulta referente a tu privacidad, puedes contactarnos en: <code class="text-cyan-600 dark:text-cyan-400">privacy@glodaxia.com</code>.
                </p>
            ...
            @else
                ...
                <p>
                    The data controller for information processed through this website is the editorial team of <strong>Glodaxia</strong>. For privacy-related inquiries, contact us at: <code class="text-cyan-600 dark:text-cyan-400">privacy@glodaxia.com</code>.
                </p>
