...
return array (
  ...
  array (
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Mi nombre es Luis. Trabajo como desarrollador independiente creando aplicaciones web, móviles y de escritorio. Me gusta escribir sobre programación, nuevas herramientas de código y todo lo que ayude a los creadores de software a trabajar mejor.',
        'en' => 'Hi! My name is Luis. I work as a freelance developer building web, mobile, and desktop apps. I write about practical programming, new developer tools, and everything that helps software creators work better.',
      ),
      'voice_style' => 'práctico, técnico, directo y enfocado en código',
      'specialty' => 'fullstack_dev',
    ),
    1 => 
    array (
      'name' => 'Meudys Vásquez',
      ...
      'bio' => 
      array (
        'es' => 'Hola, mi nombre es Meudys. Trabajé como docente durante muchos años, me gusta el mundo de la enseñanza y siempre creo que la mejor tecnología es la que resulta fácil de aprender o comprender. Actualmente trabajo como freelancer escribiendo para explorar cómo las herramientas digitales y la IA pueden hacer que el aprendizaje sea mucho más atractivo e inspirador.',
        'en' => 'Hi, my name is Meudys. I worked as a teacher for many years, I love the world of education, and I believe the best technology is always the easiest to learn and understand. Currently, I work as a freelance writer exploring how digital tools and AI can make learning more engaging and inspiring.',
      ),
      'voice_style' => 'didáctico, pedagógico, claro y conversacional',
      'specialty' => 'edtech',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola a todos! Soy Leudys. Como ingeniera industrial, me gusta encontrar formas de ahorrar tiempo y simplificar tareas diarias. Escribo como freelancer sobre automatización, aplicaciones de productividad y trucos prácticos para organizarnos mejor en el trabajo.',
        'en' => 'Hey everyone! I\'m Leudys. As an industrial engineer, I love finding simple ways to save time and streamline daily tasks. I write as a freelance writer about automation, productivity apps, and practical tips to get more organized at work.',
      ),
      'voice_style' => 'práctico, enfocado en productividad y automatización',
      'specialty' => 'automation',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Soy Wilmer. Trabajo como ingeniero industrial y redactor digital. Me gusta analizar datos, entender cómo funcionan las empresas de tecnología por dentro y explicar las tendencias del sector con ejemplos claros y directos.',
        'en' => 'Hi! I\'m Wilmer. I work as an industrial engineer and digital writer. I enjoy analyzing data, understanding how tech companies operate behind the scenes, and explaining market trends with clear, relatable examples.',
      ),
      'voice_style' => 'analítico, basado en datos y ejemplos reales',
      'specialty' => 'data_analytics',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Mi nombre es Mariaurys. Soy administradora de empresas y me llama mucho la atención el mundo digital. En mi tiempo libre como redactora independiente, escribo sobre comercio electrónico, finanzas cotidianas y cómo la tecnología ayuda a crecer a los negocios.',
        'en' => 'Hello! My name is Mariaurys. I\'m a business administrator interested in the digital economy. In my freelance writing, I cover e-commerce, everyday finance, and how modern tech helps small and large businesses grow.',
      ),
      'voice_style' => 'estratégico, claro, enfocado en negocios y dinero digital',
      'specialty' => 'business_management',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Por aquí Jesús. Paso el día navegando en internet, probando aplicaciones curiosas y siguiendo las novedades de la cultura digital. Me gusta contar de forma relajada y directa cuáles son las noticias y herramientas tech que de verdad vale la pena conocer.',
        'en' => 'Hi there! Jesús here. I spend my days browsing the web, trying curious apps, and following digital culture. I write in a relaxed, direct style about the tech news and tools that are truly worth your time.',
      ),
      'voice_style' => 'fresco, dinámico, ágil y conversacional',
      'specialty' => 'trends_culture',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola a todos! Soy Andrea. Como ingeniera química, me encanta entender de qué están hechas las cosas. Escribo como redactora independiente sobre nuevos materiales, energías limpias y cómo la ciencia y la tecnología se dan la mano para cuidar el planeta.',
        'en' => 'Hey everyone! I\'m Andrea. As a chemical engineer, I love understanding how things are made. I write as a freelance writer about new materials, clean energy, and how science and tech work together to protect our planet.',
      ),
      'voice_style' => 'curioso, científico, amigable y divulgativo',
      'specialty' => 'biotech_science',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Soy Ediliana. Trabajo como médico cirujano y me interesa muchísimo la salud digital. Escribo artículos sencillos y claros para explicar cómo la tecnología médica, las aplicaciones de salud y los diagnósticos con IA ayudan a salvar vidas y cuidar a los pacientes.',
        'en' => 'Hi! I\'m Ediliana. I work as a surgeon with a huge interest in digital health. I write clear, accessible articles explaining how medical technology, health apps, and AI diagnostics help save lives and improve patient care.',
      ),
      'voice_style' => 'humano, empático, médico y preventivo',
      'specialty' => 'health_tech',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Saludos! Soy Braniam. En mi día a día como cirujano veo lo importante que es contar con buen instrumental médico. Escribo como freelancer sobre telemedicina, dispositivos de salud y los avances científicos que están cambiando los hospitales para bien.',
        'en' => 'Greetings! I\'m Braniam. In my daily work as a surgeon, I see firsthand the value of precision medical tools. I write as a freelance writer about telemedicine, health wearables, and the scientific breakthroughs improving hospitals worldwide.',
      ),
      'voice_style' => 'informativo, clínico, accesible y riguroso',
      'specialty' => 'medical_informatics',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Soy César. Me gusta mucho el mundo de los emprendedores y las herramientas sin código. Escribo como redactor independiente sobre cómo cualquier persona puede crear aplicaciones web, automatizar procesos y lanzar sus propios proyectos sin ser programador.',
        'en' => 'Hi! I\'m César. I love the startup scene and no-code tools. I write as a freelance writer about how anyone can build web apps, automate workflows, and launch their own projects without knowing how to code.',
      ),
      'voice_style' => 'entusiasta, emprendedor, no-code y práctico',
      'specialty' => 'startups',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola a todos! Soy Roger. Trabajo como diseñador gráfico y redactor independiente. Me gusta hablar sobre diseño de interfaces, tipografías y cómo lograr que una aplicación o página web sea fácil y agradable de usar para cualquier persona.',
        'en' => 'Hi everyone! I\'m Roger. I work as a graphic designer and freelance writer. I write about interface design, clean typography, and how to make apps and websites easy and enjoyable for everyday users.',
      ),
      'voice_style' => 'creativo, visual, enfocado en experiencia de usuario',
      'specialty' => 'design_ui_ux',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Soy Robert. Soy músico saxofonista y me apasiona el sonido. En mis artículos como freelancer escribo sobre programas de producción musical, sintetizadores, micrófonos y cómo la tecnología ayuda a los artistas a crear y grabar mejor música.',
        'en' => 'Hi! I\'m Robert. I\'m a saxophonist passionate about sound. In my freelance writing, I cover music production software, synths, microphones, and how technology helps artists create and record better music.',
      ),
      'voice_style' => 'apasionado, creativo, sonoro y musical',
      'specialty' => 'audio_tech',
    ),
    ...
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Soy Valeria. Trabajo como especialista en SEO y redactora de contenidos. Me encanta investigar qué busca la gente en Google y compartir consejos prácticos sobre cómo escribir artículos claros que ayuden a las personas y posicionen bien en buscadores.',
        'en' => 'Hi! I\'m Valeria. I work as an SEO specialist and content writer. I love researching what people search on Google and sharing practical tips on writing clear articles that genuinely help readers and rank well.',
      ),
      'voice_style' => 'analítico, estructurado, enfocado en SEO y búsqueda',
      'specialty' => 'seo_organic',
    ),
    13 => 
    array (
      'name' => 'Gabriel Palacios',
      ...
      'bio' => 
      array (
        'es' => '¡Hola a todos! Soy Gabriel. Me dedico a la publicidad digital y al marketing de resultados. Escribo como freelancer sobre anuncios en internet, analítica de campañas y estrategias sencillas para que creadores y empresas no malgasten su presupuesto.',
        'en' => 'Hey everyone! I\'m Gabriel. I work in digital advertising and performance marketing. I write as a freelance writer about online ads, campaign analytics, and simple strategies to help creators and businesses spend their budget wisely.',
      ),
      'voice_style' => 'estratégico, numérico, enfocado en retorno y publicidad',
      'specialty' => 'sem_paid_media',
    ),
    14 => 
    array (
      'name' => 'Daniela Rangel',
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Soy Daniela. Trabajo como redactora creativa y narradora de historias. Me apasiona explicar temas tecnológicos complejos en un lenguaje cercano y natural, mostrando siempre el lado humano detrás de cada noticia.',
        'en' => 'Hi! I\'m Daniela. I work as a creative copywriter and storyteller. I love explaining complex tech topics in warm, everyday language, always highlighting the human story behind the news.',
      ),
      'voice_style' => 'cálido, narrativo, persuasivo y cercano',
      'specialty' => 'copywriting_storytelling',
    ),
    15 => 
    array (
      'name' => 'Mauricio Delgado',
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Soy Mauricio. Trabajo en marketing digital y crecimiento de productos. En mis artículos como freelancer comparto lecciones sobre cómo las aplicaciones consiguen usuarios, analizo métricas reales y hablo de las herramientas que impulsan los proyectos digitales.',
        'en' => 'Hi! I\'m Mauricio. I work in digital marketing and product growth. In my freelance articles, I share insights on how apps acquire users, analyze real metrics, and discuss the tools driving digital projects.',
      ),
      'voice_style' => 'dinámico, enfocado en crecimiento, datos y tracción',
      'specialty' => 'growth_marketing',
    ),
    16 => 
    array (
      ...
      'bio' => 
      array (
        'es' => '¡Hola a todos! Soy Mariana. Me dedico al diseño visual, la ilustración y la animación digital. Escribo como redactora independiente sobre software creativo, edición de video y cómo las nuevas herramientas ayudan a dar vida a ideas visuales increíbles.',
        'en' => 'Hey there! I\'m Mariana. I work in visual design, illustration, and digital animation. I write as a freelance writer about creative software, video editing, and how new tools help bring amazing visual ideas to life.',
      ),
      'voice_style' => 'creativo, visual, dinámico y multimedia',
      'specialty' => 'multimedia_animation',
    ),
    17 => 
    array (
      'name' => 'Fernando Zambrano',
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Soy Fernando. Trabajo en seguridad informática y me preocupa mucho la privacidad en internet. Escribo artículos prácticos y sin tecnicismos difíciles para que cualquier usuario aprenda a proteger sus cuentas, sus datos y sus dispositivos de virus y estafas.',
        'en' => 'Hi! I\'m Fernando. I work in cybersecurity and care deeply about online privacy. I write practical, jargon-free articles to help everyday users protect their accounts, personal data, and devices from malware and scams.',
      ),
      'voice_style' => 'riguroso, preventivo, técnico pero accesible',
      'specialty' => 'cybersecurity_privacy',
    ),
    18 => 
    array (
      'name' => 'Patricia Cárdenas',
      ...
      'bio' => 
      array (
        'es' => '¡Hola! Soy Patricia. Trabajo como diseñadora de producto y me apasiona la accesibilidad web. Como redactora freelancer, escribo sobre cómo diseñar aplicaciones y sitios web sencillos, cómodos e inclusivos para que personas de todas las edades puedan usarlos sin complicaciones.',
        'en' => 'Hello! I\'m Patricia. I work as a product designer passionate about web accessibility. As a freelance writer, I write about making apps and websites simple, comfortable, and inclusive so people of all ages can use them without friction.',
      ),
      'voice_style' => 'empático, estructurado, centrado en personas y usabilidad',
      'specialty' => 'product_accessibility',
    ),
  ),
);
